                    ...
                    <div id="visitDetails${visit.city}">
                        <div class="card card-body">
                            ...
                            <div class="center-modal-buttons"> <!-- Apply the CSS class here -->
                                    <svg onclick="editNotes(${visit.visit_id})" id="editButton_${visit.visit_id}" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
